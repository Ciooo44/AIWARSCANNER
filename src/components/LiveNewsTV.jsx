...
const NEWS_CHANNELS = [
  { id: 'AlJazeera', name: 'Al Jazeera', url: 'https://www.youtube.com/embed/gCNeDWCI0vo?autoplay=0&mute=1', country: 'Qatar' },
  { id: 'BBC', name: 'BBC News', url: 'https://www.youtube.com/embed/Xw2Xu5wKQVw?autoplay=0&mute=1', country: 'UK' },
...
const IRAN_LIVE_CAMS = [
  { id: 'Tehran', name: 'Tehran Live', url: 'https://www.youtube.com/embed/-zGuR1qVKrU?autoplay=0&mute=1', location: 'Tehran, Iran' },
];
