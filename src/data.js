...
export const CRISIS_TIMELINE = [
  ...
  { date: "Feb 28, 2026", event: "🔴🔴🔴 WAR STARTED: US launches massive strikes on Iran — Tehran, Natanz, Fordow, Isfahan hit. Iran retaliating. Strait of Hormuz CLOSED.", severity: "critical" },
...
export const NEWS_ITEMS = [
  { time: "🔴🔴🔴 LIVE", source: "Multiple / Breaking", title: "🔴🔴🔴 WAR STARTED: US launches massive strikes on Iran — explosions in Tehran, Natanz, Fordow, Isfahan. Iran retaliating with ballistic missiles.", category: "military", url: "https://www.bbc.com/news/world-middle-east" },
