...
export const CRISIS_TIMELINE = [
  ...
  { date: "Feb 28, 2026", event: "🇹🇷 US EMBASSY TURKEY ALERT: Americans urged to avoid southeastern provinces — US personnel barred from Adana travel", severity: "critical" },
  { date: "Feb 28, 2026", event: "🇺🇸 IRANIAN DRONE HITS US NAVY BASE: Shahed drone reportedly struck US Navy base in Bahrain — Direct attack on US forces", severity: "critical" },
...
export const NEWS_ITEMS = [
  { time: "🇹🇷🟠 17:39", source: "US Embassy Turkey / Security Alert", title: "🇹🇷 US EMBASSY TURKEY SECURITY ALERT: Americans urged to AVOID travel to southeastern provinces bordering Iran, Iraq, Syria — U.S. personnel BARRED from personal travel to Adana consular district amid heightened tensions", category: "diplomacy", url: "https://travel.state.gov/" },
  { time: "🇺🇸🔴 17:39", source: "Regional / Breaking", title: "🇺🇸 IRANIAN DRONE HITS US NAVY BASE IN BAHRAIN: Iranian Shahed drone reportedly hit a U.S. Navy base in Bahrain — Major escalation — US personnel at risk — This is a direct attack on US forces", category: "military", url: "https://www.reuters.com/world/middle-east/" },
