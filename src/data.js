...
export const NEWS_ITEMS = [
  { time: "🔥 JUST IN", source: "BBC", title: "🚨🚨🚨 Anti-government student protests spread to more Iranian universities — fresh wave began Saturday", category: "protest", url: "https://www.bbc.com/news/articles/clyxrv8z0vdo" },
  { time: "⚡ BREAKING", source: "BBC", title: "US partially evacuates Beirut embassy amid rising Iran tensions — State Department orders non-essential staff out", category: "military", url: "https://www.bbc.com/news/articles/cj32l00k47lo" },
  { time: "JUST NOW", source: "BBC", title: "Israeli strikes kill at least 10 in Lebanon — among deadliest since ceasefire ended", category: "military", url: "https://www.bbc.com/news/articles/cvg8914dkl0o" },
  { time: "2m ago", source: "BBC", title: "Trump 'curious why Iran has not capitulated' — US envoy Witkoff says president puzzled by lack of compromise", category: "diplomacy", url: "https://www.bbc.com/news/articles/cn5gk15rr70o" },
  { time: "5m ago", source: "CNN", title: "US military pulls last troops from key military facility in Syria — ISIS concerns remain", category: "military", url: "https://edition.cnn.com/2026/02/12/politics/us-troops-withdrawal-syria-isis" },
  { time: "8m ago", source: "CNN", title: "As Iran cracks down, Trump faces three risky paths forward — analysis of administration options", category: "analysis", url: "https://edition.cnn.com/2026/01/29/politics/iran-crack-down-trump-three-risky-paths-forward" },
  { time: "15m ago", source: "NY Times / Times of Israel", title: "TRUMP PLAN REVEALED: Initial LIMITED strike on Iran, escalating to REGIME CHANGE if no results", category: "military", url: "https://www.timesofisrael.com/liveblog_entry/ny-times-trump-weighing-initial-limited-iran-strike-but-going-for-regime-change-if-no-results/" },
  { time: "22m ago", source: "Live Tracking", title: "USS GERALD R. FORD POSITIONED OFF ISRAEL — CVN-78 now 50km from Haifa coast", category: "military", url: "https://twitter.com/search?q=USS+Ford+Israel" },
  { time: "30m ago", source: "Die Welt", title: "Iran warns of 'full force' response — Tehran: Even 'limited' attack will be answered with full harshness", category: "diplomacy", url: "https://www.welt.de/politik/ausland/article699c3ec8ee35d0f0647c4a06/iran-usa-konflikt-teheran-warnt-vor-voller-haerte-bei-jedem-angriff.html" },
  { time: "38m ago", source: "The New Arab", title: "Regional sources report heightened military activity near Iran border — potential strike preparations", category: "military", url: "https://x.com/The_NewArab/status/2025920604805701710" },
  { time: "45m ago", source: "Al Jazeera", title: "IRGC conducts overnight missile drills near Natanz — satellite imagery shows increased activity", category: "military", url: "https://www.aljazeera.com/news/" },
  { time: "50m ago", source: "BBC", title: "Russia warns US against 'dangerous escalation' — Lavrov: 'Iran strike would destabilize entire region'", category: "diplomacy", url: "https://www.bbc.com/news/world/middle_east" },
  { time: "1h ago", source: "CNN", title: "DEFCON level raised at CENTCOM bases — personnel recall ordered for weekend", category: "military", url: "https://www.cnn.com/politics" },
  { time: "2h ago", source: "Washington Post", title: "Iran dispatches Revolutionary Guard to nuclear sites — civilian evacuations near Fordow", category: "military", url: "https://www.washingtonpost.com/world/" },
  { time: "3h ago", source: "Financial Times", title: "Oil traders brace for weekend volatility — Brent futures surge on strike speculation", category: "economic", url: "https://www.ft.com" },
];
